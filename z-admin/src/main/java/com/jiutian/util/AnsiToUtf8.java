...
public static void main(String[] args) throws UnsupportedEncodingException, IOException {
        ...
        Vector<String> vec=tmp.FileNameOftype("D:/xinrenworkspace/xinrenol_debt_cd_20180801gb/p2p_core_chinapnr/src/main/java/com/rd/p2p/core/ws/client/match", ".java");
